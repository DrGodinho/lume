        ...
        <div className="bg-[#04080f] text-white min-h-screen">
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/bangu_hero_bg.webp" alt="Instalação de insulfilm profissional em Bangu - LUME Controle Solar" fill sizes="(max-width: 768px) 100vw, 100vw" priority className="w-full h-full object-cover" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            },
                            {
                                ...
                                desc: "Trabalhamos com películas de procedência que não criam bolhas nem ficam roxas, com garantia oficial de 5 anos pela Lume."
                            }
                        ].map((benefit, idx) => (
