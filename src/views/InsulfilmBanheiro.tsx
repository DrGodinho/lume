...
const faqs = [
  {
    q: "A película jateada resiste à umidade do banheiro?",
    a: "Sim, absolutamente. Nossas películas jateadas são projetadas para suportar ambientes úmidos como banheiros. A adesão profissional garante que a película não descole, não forme bolhas e mantenha suas propriedades mesmo com o vapor constante do chuveiro."
  },
  {
    q: "Como devo limpar a película jateada no banheiro?",
    a: "A limpeza é simples e prática: use um pano macio ou flanela com água e sabão neutro. Evite esponjas abrasivas, palhas de aço ou produtos químicos agressivos que possam riscar a superfície fosca da película."
  },
  {
    q: "A película jateada escurece o banheiro?",
    a: "Não. A película jateada é translúcida, ou seja, ela difunde a luz natural mantendo o ambiente claro e arejado. A diferença é que quem está do lado de fora não consegue ver o que está dentro, garantindo total privacidade."
  },
  {
    q: "Quanto tempo demora a instalação no box do banheiro?",
    a: "Para um box de banheiro padrão, a instalação é realizada em aproximadamente 40 minutos a 1 hora, de forma limpa e silenciosa, sem sujeira ou necessidade de obras."
  }
];
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden px-4">
        ...
        <div className="container-lume relative z-10 page-entrance text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black font-montserrat mb-6 leading-tight">
            Insulfilm para Banheiro: <span className="text-gradient-gold">Privacidade Total</span> sem Perder a Luz
          </h1>

          <p className="text-lg md:text-xl text-gray-300 mx-auto mb-10 leading-relaxed font-light">
            A solução definitiva para quem busca privacidade no banheiro sem abrir mão da claridade natural. A película jateada transforma vidros transparentes em superfícies foscas com acabamento sofisticado e profissional.
          </p>

          <a
            href="https://wa.me/5521965140612?text=Ol%C3%A1%2C%20gostaria%20de%20um%20or%C3%A7amento%20de%20insulfilm%20para%20meu%20banheiro!"
            target="_blank"
