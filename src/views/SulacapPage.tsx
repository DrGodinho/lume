            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4">
                ...
                <div className="container-lume relative z-20 page-entrance text-center md:text-left pt-24 pb-12">
                    ...
                    <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto md:mx-0 mb-10 leading-relaxed font-light">
                        Eleve o conforto da sua casa com películas de controle solar de alta performance. Proteção contra o calor intenso, privacidade absoluta e economia real para moradores do Jardim Sulacap e adjacências, com películas a partir de R$ 80/m².
                    </p>
