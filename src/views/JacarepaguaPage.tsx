...
export function JacarepaguaPage({ faqs }: { faqs: { q: string; a: string }[] }) {
    return (
        <div className="bg-[#04080f] text-white min-h-screen">
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4">
                ...
                <div className="container-lume relative z-20 page-entrance text-center md:text-left pt-24 pb-12">
                    ...
                    <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto md:mx-0 mb-10 leading-relaxed font-light">
                        Proteja seu lar ou comércio no coração da Zona Oeste com películas de controle solar de elite. Atendimento especializado na Freguesia, Taquara, Pechincha e região, com películas a partir de R$ 90/m².
                    </p>
            ...
            {/* Preço de Insulfilm em Jacarepaguá - Cross-link para o post campeão de conversão */}
                ...
                <div className="container-lume page-entrance max-w-4xl mx-auto">
                    <div className="glass-card p-8 md:p-10 rounded-3xl border border-[#c9a227]/30 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                        <div className="flex-1">
                            <h2 className="text-2xl lg:text-3xl font-bold font-montserrat mb-3 text-white">Preço de insulfilm em Jacarepaguá em 2026</h2>
