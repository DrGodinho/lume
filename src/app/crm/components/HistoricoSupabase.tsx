                ...
                <tr key={item.id} className="cursor-pointer hover:bg-white/[0.01]" onClick={() => setSelectedOrcamento(item)}>
                  ...
                  <td className="py-3.5 text-right">
                    <div className="flex justify-end gap-3">
                      <button type="button" onClick={() => setSelectedOrcamento(item)} className="text-white/40 hover:text-white" title="Ver detalhes">
                        <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      ...
                      <button type="button" onClick={() => void deleteOrcamento(item.id)} className="text-white/30 hover:text-red-400" title="Excluir">
                        <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
