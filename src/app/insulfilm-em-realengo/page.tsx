...
export const metadata: Metadata = {
  ...
  description: 'Procurando insulfilm em Realengo? A LUME oferece as melhores películas de controle solar com garantia de 2 anos. Reduza o calor e economize energia hoje!',
  keywords: [
