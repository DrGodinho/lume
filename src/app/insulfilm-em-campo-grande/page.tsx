...
export const metadata: Metadata = {
  ...
  description: 'Aplicação profissional de insulfilm em Campo Grande, Rio de Janeiro. Películas a partir de R$ 90/m²: redução de calor, privacidade e proteção UV com garantia de 2 anos. Orçamento grátis no local e pelo WhatsApp.',
  keywords: [
    'insulfilm em campo grande rj',
    'insulfilm campo grande rj',
    'preço de insulfilm campo grande',
    'insulfilm campo grande preço',
    'aplicação de insulfilm campo grande',
    'instalação de insulfilm campo grande',
    'insulfilm residencial campo grande',
    'lume controle solar campo grande',
    'insulfilm barato campo grande'
  ],
...
const campoGrandeFaqs = [
  {
    q: 'Quanto custa instalar insulfilm residencial em Campo Grande?',
  ...
  {
    q: 'Qual o melhor tipo de insulfilm para casas em Campo Grande?',
  ...
  {
    q: 'Atendem condomínios e empresas em Campo Grande?',
    a: 'Sim. Atendemos residências em condomínios, lojas de rua, centros comerciais, clínicas, escritórios e qualquer ambiente comercial arquitetônico na região, incluindo Bangu e Realengo.',
  },
  {
    q: 'Insulfilm é proibido ou ilegal em Campo Grande?',
  ...
  {
    q: 'Quanto tempo leva para instalar insulfilm em Campo Grande?',
...
const jsonLd = {
  ...
  '@graph': [
    ...
    {
      '@type': 'FAQPage',
      'mainEntity': campoGrandeFaqs.map((item) => ({
        '@type': 'Question',
        'name': item.q,
        'acceptedAnswer': {
          '@type': 'Answer',
...
export default function Page() {
  return (
    <>
      ...
      />
      <CampoGrandePage faqs={campoGrandeFaqs} />
    </>
  );
}
