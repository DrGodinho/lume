...
const staticRoutes = [
  { path: '/', priority: 1, changeFrequency: 'monthly', lastModified: '2026-07-29' },
  { path: '/simulador/', priority: 0.8, changeFrequency: 'monthly', lastModified: '2026-04-27' },
  { path: '/guia-insulfilm/', priority: 0.8, changeFrequency: 'monthly', lastModified: '2026-07-29' },
  { path: '/blog/', priority: 0.9, changeFrequency: 'weekly', lastModified: '2026-07-08' },
  { path: '/nano-ceramica/', priority: 0.9, changeFrequency: 'monthly', lastModified: '2026-07-29' },
  { path: '/carbono/', priority: 0.9, changeFrequency: 'monthly', lastModified: '2026-07-29' },
  ...
  { path: '/insulfilm-em-bangu/', priority: 0.7, changeFrequency: 'weekly', lastModified: '2026-07-29' },
  { path: '/insulfilm-em-realengo/', priority: 0.7, changeFrequency: 'weekly', lastModified: '2026-07-29' },
  { path: '/insulfilm-em-campo-grande/', priority: 0.7, changeFrequency: 'weekly', lastModified: '2026-07-29' },
  { path: '/insulfilm-em-jacarepagua/', priority: 0.7, changeFrequency: 'weekly', lastModified: '2026-07-29' },
  { path: '/insulfilm-na-barra-da-tijuca/', priority: 0.7, changeFrequency: 'weekly', lastModified: '2026-07-29' },
  { path: '/insulfilm-no-recreio/', priority: 0.7, changeFrequency: 'weekly', lastModified: '2026-07-29' },
  { path: '/insulfilm-em-sulacap/', priority: 0.7, changeFrequency: 'weekly', lastModified: '2026-07-29' },
  ...
  { path: '/insulfilm-no-quarto/', priority: 0.8, changeFrequency: 'monthly', lastModified: '2026-07-29' },
  ...
  { path: '/insulfilm-para-portas-de-vidro/', priority: 0.8, changeFrequency: 'monthly', lastModified: '2026-07-29' },
