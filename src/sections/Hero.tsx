    ...
    >
      ...
      <div className="relative z-20 container-lume pt-24 sm:pt-20 pb-10 sm:pb-12">
        <HeroEntrance className="max-w-3xl">
          {/* Badge */}
          <div className="animate-hero opacity-0 inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-[#c9a227]/10 border border-[#c9a227]/30 mb-4 sm:mb-6">
          ...
          {/* CTA Buttons */}
          <div className="animate-hero opacity-0 flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-10">
            <GtagLink
          ...
          {/* Trust Badge */}
          <div className="animate-hero opacity-0 flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-400">
