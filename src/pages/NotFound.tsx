...
export function NotFound() {
    ...
    return (
        <div className="bg-[#070f1a] text-white min-h-screen flex items-center justify-center relative overflow-hidden px-4 py-20">
            <Helmet>
                <title>Página Não Encontrada | LUME Controle Solar</title>
                <meta name="description" content="Desculpe, a página que você está procurando não existe. Volte para a página inicial da LUME Controle Solar." />
